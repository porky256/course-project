...
func (m *MockDatabaseRepo) GetRoom(id int) (*models.Room, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseRepoMockRecorder) GetRoom(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoom", reflect.TypeOf((*MockDatabaseRepo)(nil).GetRoom), id)
}
